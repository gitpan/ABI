# This Makefile is for the ABI extension to perl.
#
...
manifypods : pure_all ABI.pm
	@$(POD2MAN) \
	ABI.pm \
	$(INST_MAN3DIR)/ABI.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"ABI\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>ABI</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > ABI.ppd
